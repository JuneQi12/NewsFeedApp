...
class NewsFeedFragment : Fragment(), NewsFeedAdapter.ItemClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        newsFeedViewModel = (mContext as NewsFeedActivity).getViewModel()
    ...
    private fun initNewsFeed() {
        newsFeedLiveData = newsFeedViewModel.retrieveNewsFeed(
            ...
            (mContext as NewsFeedActivity).application
        )
    }
    ...
    override fun onItemClicked(position: Int) {
        ...
        if (!newsFeedViewModel.getWebViewUrl(position).isNullOrBlank()) {
            ...
            (mContext as NewsFeedActivity).supportFragmentManager
                .beginTransaction()
                .replace(
    ...
    override fun onResume() {
        super.onResume()
        try {
            (mContext as NewsFeedActivity).showToolBar()
