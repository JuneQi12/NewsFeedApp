...
import com.june.newsfeed.app.util.NewsFeedHelperUtil
import com.june.newsfeed.app.util.withArgs
...
class NewsFeedDetailsFragment : Fragment() {
    ...
    override fun onResume() {
        super.onResume()
        try {
            (mContext as NewsFeedActivity).hideToolBar()
                ...
                if (isAdded && !isDialogShown) {
                    ...
                    NewsFeedHelperUtil.showGenericErrorMessage(mContext,
                        ...
                        DialogInterface.OnClickListener { _, _ ->
                            ...
                            try {
                                if ((mContext as NewsFeedActivity).supportFragmentManager.backStackEntryCount > 1)
                                    (mContext as NewsFeedActivity).supportFragmentManager.popBackStack()
